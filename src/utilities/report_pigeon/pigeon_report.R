...
source(paste(utilities.path, "pigeon_generatePDFreport.R", sep = "/"))
...
pdf.report.file <- paste0(report.prefix, "_pigeon_report.pdf");
html.report.file <- paste0(output_name, "_pigeon_report.html");
...
if (report.format == 'both') {
  ...
  rmarkdown::render(input = paste(utilities.path, "pigeon_report.Rmd", sep = "/"), output_dir =  output_directory , output_file=html.report.file)
