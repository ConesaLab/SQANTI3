...
### Common arguments for both modes
    ...
    common.add_argument('--filter_sam', help='SAM alignment of the input fasta/fastq')
    common.add_argument('--filter_faa', help='ORF prediction faa file to be filtered by SQANTI3')
