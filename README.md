...
## Installation
The latest SQANTI3 release (04/10/2023) is **version 5.2**. See our wiki for [installation instructions](https://github.com/ConesaLab/SQANTI3/wiki/Dependencies-and-installation).
