...
**Mandatory**: the basic input required to run IsoAnnotLite are three of the [output files](Understanding-the-output-of-SQANTI3-QC.md) generated by [SQANTI3 QC](Running-SQANTI3-Quality-Control.md):
