...
if (exists("cage.ISM.list")) {
    ...
    for (i in 1:length(cage.ISM.list)){
      print(htmltools::tagList(ggplotly(cage.ISM.list[[i]])%>%layout(width=700, margin = list(r = 150))))
      print(htmltools::tagList(ggplotly(cage.ISM.list.a[[i]])%>%layout(width=700, margin = list(r = 150))))
    }
  }
}
cat ('\n')
...
if (exists("cage_hist_NNC")) {
    ...
    for (i in 1:length(cage.NNC.list)){
      ggplotly(cage.NNC.list[[i]])
      ggplotly(cage.NNC.list.a[[i]])
    }
  }
}
cat ('\n')
