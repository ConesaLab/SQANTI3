...
for (i in 1:length(p1.s.list)) {
  ...
  print(htmltools::tagList(ggplotly(p1.s.list[[i]])%>%
                             layout(margin = list(r = 130), showlegend = F, width=700)))
  cat('  \n\n')
...
if (length(p21.FSM.list) > 0) {
  ...
  for (i in 1:length(p21.FSM.list)) {
    cat ('\n####', p21.stitles.FSM[[i]][1], '\n')
    print(htmltools::tagList(ggplotly(p21.FSM.list[[i]])%>%layout(width=700)))
    print(htmltools::tagList(ggplotly(p21.FSM.list.a[[i]])%>%layout(width=700)))
...
if (length(p21.ISM.list)>0) {
  ...
  for (i in 1:length(p21.ISM.list)) {
    cat ('\n####', p21.stitles.ISM[[i]][1], '\n')
    print(htmltools::tagList(ggplotly(p21.ISM.list[[i]]) %>% layout(width=700)))
    print(htmltools::tagList(ggplotly(p21.ISM.list[[i]])%>% layout(width=700)))
  }
}
```
...
if (exists("cage.FSM.list")) {
    ...
    for (i in 1:length(cage.FSM.list)){
      print(htmltools::tagList(ggplotly(cage.FSM.list[[i]])%>%layout(width=700)))
      print(htmltools::tagList(ggplotly(cage.FSM.list.a[[i]])%>%layout(width=700)))
...
if (exists("cage.ISM.list")) {
    ...
    for (i in 1:length(cage.ISM.list)){
      print(htmltools::tagList(ggplotly(cage.ISM.list[[i]])%>%layout(width=700)))
      print(htmltools::tagList(ggplotly(cage.ISM.list.a[[i]])%>%layout(widt=700)))
    }
  }
}
cat ('\n')
...
if (exists("cage_hist_NIC")) {
    ...
    for (i in 1:length(cage.NIC.list)){
      print(htmltools::tagList(ggplotly(cage.NIC.list[[i]])%>% layout(width=700)))
      print(htmltools::tagList(ggplotly(cage.NIC.list.a[[i]])%>%layout(width=700)))
    }
  }
}
