...
```{r , echo=FALSE, eval = polyA_dist_provided, results ='asis', warning=FALSE}
cat("## PolyA Distance Analysis {.tabset .tabset-fade }", '\n')
```

<!-- 1 -->

```{r p.polyA_dist, echo=FALSE, eval = polyA_dist_provided, results ='asis', warning=FALSE}
cat ('\n###'," PolyA motif", '\n')
...
```{r dist_to_cage_peak, echo = FALSE, eval = dist_to_cage_peak_provided, results ='asis', warning = FALSE}
...
#cat ('\n####', "Distance to CAGE peak of multi-exonic ISM 5prime fragments", '\n')
#ggplotly(cage_hist_ISM5frag) %>%
#    layout(margin = list(r = 130))
#ggplotly(cage_hist_ISM5frag_perc) %>%
#    layout(margin = list(r = 130))
#cat ('\n')

#cat ('\n####', "Distance to CAGE peak of multi-exonic ISM 3prime fragments", '\n')
#ggplotly(cage_hist_ISM3frag) %>%
#    layout(margin = list(r = 130))
#ggplotly(cage_hist_ISM3frag_perc) %>%
#    layout(margin = list(r = 130))
#cat ('\n')
...
```{r FSM_provided_ISM_provided, echo = FALSE, eval = FSM_provided || ISM_provided, results ='asis', warning = FALSE}
